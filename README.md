...
人生可以分隔为许许多多的阶段，其中有些是主要阶段可以分为，求学，工作，生活。其中又有许多小阶段，如在求学阶段，从初中到高中，从高中到大学，到研究生（master/ PHD），其中每个过渡阶段都需要大量的信息收集。 因为每个不同的阶段，就像不同的游戏，有不同的规则和一些技巧。在明白，自己想要什么的时，利用好这些规则与技巧非常重要。在此，我想和大家分享一些个人在这些过渡过程中，认为有用的资源。当你处于本科生转变为研究生（master/ PHD）阶段，亦或从高中转向大学，面临对于自己的下一个阶段的抉择，希望能够对于你有所帮助（目前主要是面向于升学阶段）。希望自己也能有时间持续更新这个repo，到以后工作。能够大家带来一点的经验或者，知道有一些其他的路，启发一些思考，便是这个repo最大的意义了！！
...
而这正是互联网的价值所在，相对于目前网络的氛围而言，这种开源与不求回报的分享精神算得上是互联网遗风了。因此，通过这个repo，希望能够对自己的上一个阶段做一个总结，同时也能够帮助后来人，提供一些有价值的信息。也算是对于 [Marcsims](https://space.bilibili.com/194560/channel/collectiondetail?sid=649049) 的一种接力吧！！！
...
来自浙大Peng sida老师的分享，Peng老师23年毕业于浙大，同时入职浙大做AP.


### [Make-your-research-life-easier](https://github.com/zhaoguangyuan123/Make-your-research-life-easier)

这个repo的作者分享的信息，无论是直接还是间接都极大的影响着我，算是对我目前这个阶段影响最大的人吧。初入我的研究领域时，就开始在其他平台上受到这位的影响，后面的申请也更是在他的间接引导下，去了自己比较满意的地方
...
**推荐理由**: 内容真实、直击读博过程中的挑战。  
**链接**: [The PhD Grind](./Resources/phd-grinding.pdf)



#### Advice for Early-Stage Ph.D. Students by Philip Guo  
**简介**:  也是Philip Guo 撰写的，为刚进入博士阶段的学生提供建议，包括如何选择研究方向、建立有效的工作习惯等。  
**推荐理由**: 如果只能选一篇阅读，强烈推荐此篇，内容直击核心问题。  
**链接**: [Advice for Early-Stage Ph.D. Students](https://hongtaoh.com/en/2021/09/22/philip-guo-phd-advice/)



#### A Survival Guide to a PhD by Andrej Karpathy  
**简介**: Andrej Karpathy 结合自身经历，为博士生提供了生存指南，从如何做研究到保持动力。  
**推荐理由**: 作者是深度学习领域的传奇人物，其学术和个人成长经验值得借鉴。  
...
这个是CS自学的资料合集指南，作者来自北大信科 @[PKUFlyingPig](https://github.com/PKUFlyingPig）.他已经在前言，详细介绍了如何使用这个合集。
...
我想对于这个频道你或多或少都有有所接触，其作者是Grant Sanderson，以上是他做的毕业致辞，相比于以往打鸡血的，鸡汤致辞，这个更贴近现实, 对于未来的选择，热爱只是起点，促使你行动起来，在未来的变化中因时因势制宜
...
### From [Steven M. LaValle](https://lavalle.pl/bio.html)
Steven M. LaValle 是一位传奇和伟大的科学家，主要从事 robotics and virtual reality，在他的个人网站中，他详细的写了biography，分享了他从computer vision 到 robotic，到virtual reality 以及现在的perception的研究心路历程。
